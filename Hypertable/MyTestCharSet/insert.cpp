...
int main(){
	...
	try {
		client = new Thrift::Client("localhost", 15867);
  		...
  		if (!client->namespace_exists("test_charset"))
			client->namespace_create("test_charset");

		ThriftGen::Namespace ns = client->namespace_open("test_charset");
...
*/
		...
		for(int i=0;i<insert_size;i++){
			string name="李小龙";
			string v1="李小龙",v2=rand_str(60,65),v3=rand_str(60,65);
