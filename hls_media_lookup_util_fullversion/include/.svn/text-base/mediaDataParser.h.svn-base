...
public:
    ...
    bool parseMediaData(const char* xmlFile,const std::string &mediaTag, const std::string &opt1, const std::string &opt2,const std::string &opt3,boost::unordered_map <std::string, mpuInfo> &);
